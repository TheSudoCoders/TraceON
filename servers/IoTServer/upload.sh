...
ML_SERVER_URL="$ML_SERVER_URL" # NOTE: Specify in the environment
...
aws lambda update-function-configuration --function-name ${FUNCTION_NAME} --environment "{\"Variables\":{\"S3_BUCKET\":\"$S3_BUCKET\", \"USERSTORE_TABLENAME\":\"$USERSTORE_TABLENAME\", \"TRACESTORE_TABLENAME\":\"$TRACESTORE_TABLENAME\", \"ML_SERVER_URL\":\"$ML_SERVER_URL\"}}"
